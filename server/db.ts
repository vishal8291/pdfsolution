...
import type { StoredUser, ContactMessage, SupportTicket, OtpRecord, SubscriptionRecord, UsageRecord } from "./types.js";
...
export let usageCollection:           Collection<UsageRecord>;
...
export async function connectToDatabase() {
  ...
  await Promise.all([
    ...
    usageCollection.createIndex({ userId: 1, dateKey: 1 }, { unique: true }),
  ]);
